...
class NIPTImportData(models.Model):
    ...
    #state_report_choices = (('0','数据导入'),('1','数据确认'),('2','报告生成'),('3','报告导出'))
    ...
    last_menstrual = models.DateField(verbose_name='末次月经')
    ...
    hospital = models.CharField(max_length=50, verbose_name='送检医院',blank=True)
    doctor = models.CharField(max_length=20, verbose_name='送检医生',blank=True)
    province = models.CharField(max_length=20, verbose_name='省区',blank=True)
    ...
    state_report = models.CharField(max_length=20, verbose_name='报告状态', default='0')
    person_import = models.CharField(max_length=10, verbose_name='导入人员')
    date_import = models.DateTimeField(verbose_name='导入时间')
    DS21_result = models.CharField(max_length=10, choices=DS_result_choices, default='0', verbose_name='21号唐筛结果',blank=True)
    DS21_value = models.CharField(max_length=10, verbose_name='21号唐筛值', blank=True)
    DS18_result = models.CharField(max_length=10, choices=DS_result_choices, default='0', verbose_name='18号唐筛结果',blank=True)
    DS18_value = models.CharField(max_length=10, verbose_name='18号唐筛值', blank=True)
    DSother_result = models.CharField(max_length=10, choices=DS_result_choices, default='0', verbose_name='其他唐筛结果',blank=True)
    #DSother_value = models.CharField(max_length=10, verbose_name='其他唐筛值', blank=True)
    preghistory = models.CharField(max_length=50, verbose_name='妊娠史', blank=True)
